    ...
    <div className={cn("relative", className)}>
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full aspect-video rounded-md border shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8]"
        />
      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 rounded-full bg-neutral-900/50 p-2 text-xl text-white backdrop-blur-md">
